...
$lang = array_merge($lang, array(
	...
	'IP_LOGIN_LIMIT_USE_FORWARDED_EXPLAIN'	=> ' Invece di limitare i tentativi di login tramite l’indirizzo IP, questi possono essere limitati dai valori di <var>X_FORWARDED_FOR</var>. <br /><em><strong>Attenzione:</strong> abilita questo modulo solo se si opera su un server proxy che imposta <var>X_FORWARDED_FOR</var> su valori affidabili.</em>',
	'IP_LOGIN_LIMIT_USE_FORWARDED_EXPLAIN'	=> 'Invece di limitare i tentativi di login tramite indirizzo IP, questi possono essere limitati dai valori di <var>X_FORWARDED_FOR</var>.<br /><em><strong>Attenzione:</strong> abilita questa funzione solo se si utilizza un server proxy che imposta <var>X_FORWARDED_FOR</var> su valori affidabili.</em>',
